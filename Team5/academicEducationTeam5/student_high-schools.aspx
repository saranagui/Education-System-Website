<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_high-schools.aspx.cs" Inherits="high_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="Student.aspx">Your Profile</a></li>
          ...
          <li>
              <a class="active" href="student_high-schools.aspx">High Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
