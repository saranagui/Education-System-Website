<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherElementarySchools.aspx.cs" Inherits="TeacherElementarySchools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="TeacherHome.aspx">Home</a></li>
          <li>
              <a class="active" runat="server" id="eschool" href="TeacherElementarySchools.aspx">Elementary Schools</a>
              <ul>
