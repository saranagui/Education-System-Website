<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_middle-schools.aspx.cs" Inherits="middle_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="Student.aspx">Your Profile</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="student_elementary-schools.aspx">Elementary Schools</a>
              <ul>
          ...
          <li>
              <a class="active" href="student_middle-schools.aspx">Middle Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
