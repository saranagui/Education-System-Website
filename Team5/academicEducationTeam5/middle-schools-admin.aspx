<%@ Page Language="C#" AutoEventWireup="true" CodeFile="middle-schools-admin.aspx.cs" Inherits="middle_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="index.aspx">Home</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="elementary-schools-admin.aspx">Elementary Schools</a>
              <ul>
          ...
          <li>
              <a class="active" href="middle-schools-admin.aspx">Middle Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
