<%@ Page Language="C#" AutoEventWireup="true" CodeFile="middle-schools.aspx.cs" Inherits="middle_schools" %>
...
<html>
<head>
<title>Egypt Education| Middle Schools</title>
<meta charset="utf-8">
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="index.aspx">Home</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="elementary-schools.aspx">Elementary Schools</a>
              <ul>
          ...
          <li>
              <a class="active" href="middle-schools.aspx">Middle Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
          ...
          <li>
              <a class="bold" href="high-schools.aspx">High Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
        ...
        <li><a class="bold drop" href="#">Search School</a>
          <ul>
            <li><a href="Searching.aspx">Name</a></li>
            <li><a href="Searching.aspx">Address</a></li>

            <li><a class="drop" href="#">Type</a>
              <ul>
                <li><a href="Searching.aspx">national</a></li>
                <li><a href="Searching.aspx">international</a></li>
              </ul>
            </li>
          </ul>
        </li>
