<%@ Page Language="C#" AutoEventWireup="true" CodeFile="middle-schools-adminstep.aspx.cs" Inherits="middle_schools" %>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="admin-step.aspx">Schools in Egypt</a></h1>
...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="admin-step.aspx">Home</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="elementary-schools-adminstep.aspx">Elementary Schools</a>
              <ul>
          ...
          <li>
              <a class="active" href="middle-schools-adminstep.aspx">Middle Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
