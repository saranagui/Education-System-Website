<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-home.aspx.cs" Inherits="AdminHome" %>
...
<div class="wrapper row1" />
    <div class="row1">
            <fieldset>
                <asp:button id="viewteachers" runat="server" type="button" 
                    text="View unverified teachers" OnClick="viewteachers_onclick" Width="222px"/>
            </fieldset>
    </div>
     <div class="wrapper row0">
        <p>
            <asp:PlaceHolder ID = "view_teachers" runat="server" Visible="true" />
        </p>
        </div>
    <br />
...
<!--VERIFY TEACHER-->
    ...
    <div class="row0">
            <fieldset>
                <label for="teacher_ssn">Teacher's SSN: </label>
                <input type="text" runat="server" name="teacher_ssn" id="teacher_ssn" value=""/>
            </fieldset>
    </div>
     <div class="row0">
            <fieldset>
                <label for="assign_username">Assign a username:  </label>
                <input type="text" runat="server" name="assign_username" id="teacher_username" value=""/>
            </fieldset>
    </div>
    <div class="row0">
            <fieldset>
                <label for="assign_password">Assign a password:  </label>
                <input type="text" runat="server" name="assign_password" id="teacher_password" value=""/>
            </fieldset>
        </div>
    <div class="wrapper row1" />
    <div class="row1">
            <fieldset>
                <asp:button id="Button1" runat="server" type="button" 
                    text="Verify teacher" OnClick="verifyteachers_onclick" Width="222px"/>
    ...
    <div class="row1">
            <fieldset>
                <asp:button id="viewapplications" runat="server" type="button" 
                    text="View new applications" OnClick="viewapplications_onclick" Width="223px"/>
            </fieldset>
    </div>
    <div class="wrapper row0">
        <p>
            <asp:PlaceHolder ID = "view_applications" runat="server" Visible="true" />
        </p>
        </div>
    <br />
    ...
    <div class="row1">
        <%--<form class="clear" method="post" action="#">--%>
            <fieldset>
                <asp:button id="viewstudents" runat="server" type="button" 
                    text="View newly enrolled students" OnClick="viewstudents_onclick" 
                    Width="223px"/>
            </fieldset>
    ...
    <div class="wrapper row0">
        <p>
            <asp:PlaceHolder ID = "view_students" runat="server" Visible="true" />
        </p>
        </div>
    <br />
    ...
    <div class="row0">
            <fieldset>
                <label for="student_ssn">Student's SSN: </label>
                <input type="text" runat="server" name="student_ssn" id="student_ssn" value=""/>
            </fieldset>
        
    </div>
     <div class="row0">
            <fieldset>
                <label for="assigned_username">Assign a username:  </label>
                <input type="text" runat="server" name="assigned_username" id="assigned_username" value=""/>
            </fieldset>
        
    </div>
    <div class="row0">
            <fieldset>
                <label for="assigned_password">Assign a password:  </label>
                <input type="text" runat="server" name="assigned_password" id="assigned_password" value=""/>
            </fieldset>
    ...
    <div class="row1">
            <fieldset>
                <asp:button id="Button2" runat="server" type="button" 
                    text="Verify student" OnClick="verifystudents_onclick" Width="222px"/>
    ...
    <div class="row1">
            <fieldset>
                <asp:button id="editinfo" runat="server" type="button" 
                    text="Edit school information" OnClick="editinfoonclick" Width="225px"/>
            </fieldset>
        </div>
        <br />
    ...
    <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="ann_title" id="ann_title" value=""/>
            </fieldset>
    </div>
     <div class="row0">
            <fieldset>
                <label for="ann_description">Description:  </label>
                <input type="text" runat="server" name="ann_description" id="ann_description" value=""/>
            </fieldset>
    </div>
    <div class="row0">
            <fieldset>
                <label for="ann_type">Type:  </label>
                <input type="text" runat="server" name="ann_type" id="ann_type" value=""/>
            </fieldset>
    </div>
    <div class="wrapper row1" />
    <div class="row1">
            <fieldset>
                <asp:button id="postann" runat="server" type="button" 
                    text="Post new announcement" OnClick="postann_onclick" Width="224px"/>
            </fieldset>
    </div>
    <br />
    ...
    <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="activity_name" id="activity_name" value=""/>
            </fieldset>
    ...
    <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="activity_location" id="activity_location" value=""/>
            </fieldset>
     ...
     <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="activity_description" id="activity_description" value=""/>
            </fieldset>
    ...
    <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="activity_type" id="activity_type" value=""/>
            </fieldset>
       
        </div>
            <div class="row0">
            <fieldset>
                <label for="teachers_ssn">Teacher's_ssn:  </label>
                <input type="text" runat="server" name="teachers_ssn" id="teachers_ssn" value=""/>
            </fieldset>
       
        </div>
    <div class="row0">
            <fieldset>
                <label for="adminstrator_ssn">Your SSN:  </label>
                <input type="text" runat="server" name="adminstrator_ssn" id="adminstrator_ssn" value=""/>
            </fieldset>
    ...
    <div class="row1">
            <fieldset>
                <asp:button id="createactivity" runat="server" type="button" 
                    text="Create new activity" OnClick="createactivity_onclick" Width="223px"/>
            </fieldset>
    </div>
    <br />
    ...
    <div class="row0">
            <fieldset>
                ...
                <input type="text" runat="server" name="course_code" id="course_code" value=""/>
            </fieldset>
        </div>
            <div class="row0">
            <fieldset>
                <label for="teacherr_ssn">Teacher's_ssn:  </label>
                <input type="text" runat="server" name="teacherr_ssn" id="teacherr_ssn" value=""/>
            </fieldset>
        </div>
         <div class="wrapper row1" />
    <div class="row1">
            <fieldset>
                <asp:button id="assignteachers" runat="server" type="button" 
                    text="Assign teachers to courses" OnClick="assignteachers_onclick" 
                    Width="226px"/>
            </fieldset>
