...
public partial class Searching_parent : System.Web.UI.Page
{
    ...
    protected void search1_Click(object sender, EventArgs e)
    {
        ...
        Server.Transfer("SearchSchoolName-parent.aspx", true);
    ...
    protected void search2_Click(object sender, EventArgs e)
    {
        ...
        Server.Transfer("SearchAddressSchool-parent.aspx", true);
    ...
    protected void search3_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SearchSchoolType-parent.aspx", true);
