...
public partial class SearchAddressSchool_parent : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("searchForSchool_address", con);
            cmd.Parameters.Add(new SqlParameter("@school_address", Session["MySchoolAddress"]));
    ...
    protected void post_Click(object sender, EventArgs e)
    {
        ...
        Server.Transfer("CheckReviews-parent.aspx", true);
    ...
    protected void post_Click1(object sender, EventArgs e)
    {
        ...
        Server.Transfer("CheckAnnouncements-parent.aspx", true);
