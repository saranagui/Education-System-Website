<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Searching-admin.aspx.cs" Inherits="Searching" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Search School</a>
          <ul>
            <li><a href="SearchSchoolName-admin.aspx">Name</a></li>
            <li><a href="SearchAddressSchool-admin.aspx">Address</a></li>
