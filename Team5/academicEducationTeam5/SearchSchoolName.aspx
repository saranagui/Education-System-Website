<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchSchoolName.aspx.cs" Inherits="SearchSchoolName" %>

<!DOCTYPE html>

<html>
<head runat="server">
<title>Egypt Education | Searching By School Names</title>
<meta charset="utf-8">
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="index.aspx">Home</a></li>
          <li>
              <a class="bold" href="elementary-schools.aspx">Elementary Schools</a>
              <ul>
