<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_elementary-schools.aspx.cs" Inherits="elementary_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="Student.aspx">Your Profile</a></li>
          <li>
              <a class="active" runat="server" id="eschool" href="student_elementary-schools.aspx">Elementary Schools</a>
              <ul>
