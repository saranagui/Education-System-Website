...
public partial class TeacherMiddleSchools : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select S.* from Middle_Schools E join Schools S on E.school_code=S.school_code", con);
