<%@ Page Language="C#" AutoEventWireup="true" CodeFile="elementary-schools-admin.aspx.cs" Inherits="elementary_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="admin-home.aspx">Home</a></li>
          <li>
              <a class="active" runat="server" id="eschool" href="elementary-schools-admin.aspx">Elementary Schools</a>
              <ul>
