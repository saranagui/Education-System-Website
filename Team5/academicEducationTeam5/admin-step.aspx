<<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeFile="admin-step.aspx.cs" Inherits="academic_education_admin_step" %>
<html>
<head>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.aspx">Administrator</a></h1>
      <p>Enter your school code to proceed</p>
    </div>
    <div class="fl_right">
...
<div class="wrapper row1" />
    <header id="header" class="clear">
        <!-- ################################################################################################ -->
        <div class="row1">
            <form class="clear" method="post" action="#" runat="server">
                <fieldset>
                    <p> School Code</p>
                    <input id="schoolcode" runat="server" type="text" value="" placeholder="please specify your school code" onclick="return schoolcode_onclick()"/>
                    <br />
                    <asp:button id="proceed" runat="server" type="button" title="proceed" Text="proceed" OnClick="proceed_onclick" />
                    <br />
                    <label id="msg" runat="server" type= "text" value="please enter a school code to proceed"/>
                </fieldset>
            </form>
        </div>
<!-- ################################################################################################ --> 
