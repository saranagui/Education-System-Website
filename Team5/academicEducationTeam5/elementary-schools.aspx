<%@ Page Language="C#" AutoEventWireup="true" CodeFile="elementary-schools.aspx.cs" Inherits="elementary_schools" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="index.aspx">Home</a></li>
          <li>
              <a class="active" runat="server" id="eschool" href="elementary-schools.aspx">Elementary Schools</a>
              <ul>
