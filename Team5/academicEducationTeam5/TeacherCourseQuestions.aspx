<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherCourseQuestions.aspx.cs" Inherits="TeacherCourseQuestions" %>
      ...
      <div class="clear">
          ...
          <h2>Write An Answer</h2>
            ...
            <div class="one_third"> -->
              ...
              <fieldset><input type="text" runat="server" name="username" id="username" value="" size="22"></fieldset>
            </div>
            <div class="one_third">
              <label for="question">The Question ID <span>*</span></label>
              <fieldset><input type="text" runat="server" name="questionID" id="questionID" value="" size="22"></fieldset>
            </div>
            <div class="one_third">
              <label for="studentUsername">Student Username <span>*</span></label>
              <fieldset><input type="text" runat="server" name="studentUsername" id="studentUsername" value="" size="22"></fieldset>
            </div>
            <div class="block clear">
              <label for="answer">Your Answer</label>
              <fieldset><textarea name="answer" id="answer" text="" runat="server" cols="100" rows="10"></textarea></fieldset>
            </div>
              <div class="row1">
            <fieldset>
                <!--OnClick="SignUp"-->
