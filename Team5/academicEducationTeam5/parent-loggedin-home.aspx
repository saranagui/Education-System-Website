<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parent-loggedin-home.aspx.cs" Inherits="parent_loggedin_home" %>
...
<html>
<head>
<title>Egypt Education| Parent Home</title>
<meta charset="utf-8">
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="parent-loggedin-home.aspx">Home</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="elementary-schools-parent.aspx">Elementary Schools</a>
              <ul>
        ...
        <li><a class="drop" href="#">Search School</a>
          ...
          <li><a class="drop" href="#">More Options</a>
               <ul>
               <li><a href="child-application.aspx">Apply For My Child</a></li>
                  <li><a href="accepted-schools.aspx">School That Accepted My Child</a></li>
                  <li><a href="child-reports.aspx">My Children's Reports</a></li>
              <li><a href="child-teachers.aspx">My Children's Teachers</a></li>
              <li><a href="child-schools.aspx">My Children's Schools </a></li>
              <li><a href="school-reviews.aspx">My School Reviews</a></li>
                    </ul>
          </li>
