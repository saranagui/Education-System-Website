...
public partial class TeacherElementarySchools : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select S.* from Elementary_Schools E join Schools S on E.school_code=S.school_code", con);
    ...
    protected void post_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("TeacherCheckReviews.aspx", true);
    ...
    protected void post_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("TeacherCheckAnnouncements.aspx", true);
