<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherMiddleSchools.aspx.cs" Inherits="TeacherMiddleSchools" %>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="TeacherHome.aspx">Schools in Egypt</a></h1>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        <li class="active"><a href="TeacherHome.aspx">Home</a></li>
          <li>
              <a class="bold" runat="server" id="eschool" href="TeacherElementarySchools.aspx">Elementary Schools</a>
              <ul>
          ...
          <li>
              <a class="active" href="TeacherMiddleSchools.aspx">Middle Schools</a>
              <ul>
                  <!--<li><a href="pages/gallery.html">Gallery</a></li>-->
                  <!--<li><a href="pages/portfolio.html">Portfolio</a></li>-->
                  <!--<li><a href="pages/full-width.html">Full Width</a></li>-->
