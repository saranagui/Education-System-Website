<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Searching-adminstep.aspx.cs" Inherits="Searching" %>
    ...
    <nav id="mainav" class="clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Search School</a>
          <ul>
            <li><a href="SearchSchoolName-adminstep.aspx">Name</a></li>
            <li><a href="SearchAddressSchool-adminstep.aspx">Address</a></li>
