...
public partial class TeacherCheckReviews : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd1.Parameters.Add(new SqlParameter("@school_code", mySchoolCode));
        ...
        while (rdr.Read())
        {
            ...
            if (!reviews.Contains(schoolName + " " + review))
            {
                ...
                cellReview.Text = "Review: " + review + "  <br /> <br />";
