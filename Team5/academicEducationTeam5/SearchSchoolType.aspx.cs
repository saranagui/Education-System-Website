...
public partial class SearchSchoolType : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("searchForSchool_type", con);
            cmd.Parameters.Add(new SqlParameter("@school_type", Session["MySchoolType"]));
